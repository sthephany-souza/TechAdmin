...
import IBS from '../../assets/logo-ibs.png';
import Hamburger from '../../assets/icone-hamburger-branco.png';

import ExcluirConta from '../ExcluirConta/ExcluirConta.jsx';
import './headerescuro.css';

function HeaderEscuro() {
  ...
  return (
    <header className="caixa_header_escuro">
        <div className='grupo_ips_hamburger'>
            <a href='/home'><img className='imagem_ibs' src={ IBS } alt='Logo TechAdmin incompleta com letreiro preto e sem fundo' /></a>
